...
from gestion_instituciones.models import Partido

class Command(BaseCommand):
    help = 'Carga los 135 partidos de la Provincia de Buenos Aires'
    ...
    def handle(self, *args, **kwargs):
        partidos = [
            ...
            "General Viamonte", "General Villegas", "Guaminí", "Hipólito Yrigoyen", "Hurlingham",
            "Ituzaingó", "José C. Paz", "Junín", "La Costa", "La Matanza", "La Plata", "Lanús",
            "Laprida", "Las Flores", "Leandro N. Alem", "Lezama", "Lincoln", "Lobería", "Lobos",
            "Lomas de Zamora", "Luján", "Magdalena", "Maipú", "Malvinas Argentinas", "Mar Chiquita",
            "Marcos Paz", "Mercedes", "Merlo", "Monte", "Monte Hermoso", "Moreno", "Morón", "Navarro",
            "Necochea", "Nueve de Julio", "Olavarría", "Patagones", "Pehuajó", "Pellegrini", "Pergamino",
        ...
        for nombre in partidos:
            _, created = Partido.objects.get_or_create(nombre=nombre)
            if created:
                contador += 1

        self.stdout.write(self.style.SUCCESS(f'¡Listo! Se cargaron {contador} partidos nuevos.'))